      ...
      {selectedDoc ? (
        <div className="border rounded-lg p-4 bg-gray-50">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
            ...
            {/* Rotation Controls */}
            <div className="flex items-center gap-2">
              <button onClick={rotateLeft} className="px-3 py-1 bg-white border rounded hover:bg-gray-100">↺ Rotate Left</button>
              <button onClick={rotateRight} className="px-3 py-1 bg-white border rounded hover:bg-gray-100">↻ Rotate Right</button>
              <button onClick={resetRotation} className="px-3 py-1 text-sm bg-gray-200 rounded hover:bg-gray-300">Reset Rotation</button>
